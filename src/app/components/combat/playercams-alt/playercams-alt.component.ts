...
@Component({
  selector: "app-playercams-alt",
  imports: [],
  templateUrl: "./playercams-alt.component.html",
  styleUrl: "./playercams-alt.component.css",
})
export class PlayercamsAltComponent implements OnInit {
